...
export interface ApiItemItem extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    price: DynamicZoneAttribute<
      ['price.regular-price', 'price.portion', 'price.portion-size']
    > &
      RequiredAttribute &
      SetPluginOptions<{
        i18n: {
...
export interface ApiTagTag extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: UIDAttribute<'api::tag.tag', 'name'> &
      RequiredAttribute &
      SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface PricePortionSize extends ComponentSchema {
  info: {
    displayName: 'Portioned Price';
    description: '';
  };
  attributes: {
    portion: ComponentAttribute<'price.portion', true> & RequiredAttribute;
  };
}

export interface PricePortion extends ComponentSchema {
  info: {
    displayName: 'Portion';
  };
  attributes: {
...
export interface PriceRegularPrice extends ComponentSchema {
  info: {
